...
VistaEntidadGlobal * ComponentsBuilder::crearEntidadGlobalEnDiagrama(VistaDiagrama * diagramaActual,
	...
	//BuscarDiagramaAncestroYEntidadNueva
	vistaEntidadNueva = diagramaActual->buscarEntidadNuevaEnAncestro(codigoEntidadNueva,
			nombreAncestro);
...
//	cout<<"llego15"<<endl;
	...
	vistaAtributo->setLinea(lineaAtributoRelacion);
//	cout<<"llego16"<<endl;
	//Agrego vatributo y vlinea a el diag
	diagramaActual->agregarComponente(vistaAtributo);
//	cout<<"llego17"<<endl;
	diagramaActual->agregarComponente(lineaAtributoRelacion);
//	cout<<"llego18"<<endl;
